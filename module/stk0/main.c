...
int FMOD_GETVER(xmod_getver_params){
    return STK0_CERT_VERIFY_VERSION;
}
...
int FMOD_INIT(xmod_init_params){
    ...
    do{
        ...
        mod_ext->init   = s10_libmod_init;
        mod_ext->exit   = s10_libmod_exit;
        mod_ext->update = s10_libmod_update;
        mod_ext->find   = s10_libmod_find;
        mod_ext->xread  = s10_libmod_xread;
        mod_ext->xwrite = s10_libmod_xwrite;
        mod_ext->xfree  = s10_libmod_xfree;
...
struct mod_struct_t *FMOD_ALLOC(xmod_alloc_params)
{
    ...
    do{    
        ...
        //    break;        
        //}   
        ptr->name = libcrt_new_str("/stk/handle");
    ...
    do{
        ...
        switch(flags){
            ...
            case STACK_VERIFY:
                ...
                if(strcmp(ptr->fdev,MOD_NAME_STR)==0 && verify == STK0_CERT_VERIFY_VERSION){ 
                    verify = 1;
                }
                *string = (void **) &verify;
            break;
