...
int FMOD_GETVER(xmod_getver_params){
    return DBI0_CERT_VERIFY_VERSION;
}
...
int FMOD_INIT(xmod_init_params){
    ...
    do{
        ...
        strcat(szdir,"/data/input");
        mod_ext->init   = d00_libmod_init;
        mod_ext->exit   = d00_libmod_exit;
        mod_ext->update = d00_libmod_update;
        mod_ext->find   = d00_libmod_find;
        mod_ext->xread  = d00_libmod_xread;
        mod_ext->xwrite = d00_libmod_xwrite;
        mod_ext->xfree  = d00_libmod_xfree;
...
struct mod_struct_t *FMOD_ALLOC(xmod_alloc_params)
{
    ...
    do{    
        ...
        //    break;        
        //}   
        ptr->name = libcrt_new_str("/data/input");
    }while(0);
    return ptr;
}
