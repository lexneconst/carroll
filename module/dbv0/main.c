...
#define MOD_NAME_STR "dbv0"

struct mod_desc_t mod_desc = {
    "dbo",
    "controls database videos",
    "interfaces/dbv/00",
    0x0000,
    0x0032,
    0x00,
...
int FMOD_GETVER(xmod_getver_params){
    return DBV0_CERT_VERIFY_VERSION;
}
...
int FMOD_INIT(xmod_init_params){
    ...
    do{
        ...
        mod_ext->init   = d20_libmod_init;
        mod_ext->exit   = d20_libmod_exit;
        mod_ext->update = d20_libmod_update;
        mod_ext->find   = d20_libmod_find;
        mod_ext->xread  = d20_libmod_xread;
        mod_ext->xwrite = d20_libmod_xwrite;
        mod_ext->xfree  = d20_libmod_xfree;
