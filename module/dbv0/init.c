...
int d20_callback_buffer(char *path_cstr)
{
     d20_libmod_update(path_cstr, strlen(path_cstr));   
}

int d20_libmod_init(char *path_dev,  struct mod_struct_t *ext_ptr, struct sysnode_proc_t *str)
{
    ...
    search(path_file, d20_callback_buffer);
    ...
    return 0;
    endl:
        d20_libmod_exit(ext_ptr, str);
        return -1;
}
int d20_libmod_exit(struct mod_struct_t *ext_ptr, struct sysnode_proc_t *str)
{
    if(data_ext!=NULL){ 
        if(data_ext->stack!=NULL)
...
int d20_libmod_update( char *buffer, unsigned int length)
{   
    #ifdef DEBUG_TEST
...
int d20_libmod_find(char *str)
{
    return 0;
}
int d20_libmod_xread(unsigned int id, cstring_t *str)
{
    return 0;
}
int d20_libmod_xwrite(unsigned int id, cstring_t *str)
{
    return 0;
}
int d20_libmod_xfree(cstring_t *str)
{
    return 0;
}
