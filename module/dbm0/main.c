...
int FMOD_GETVER(xmod_getver_params){
    return DBM0_CERT_VERIFY_VERSION;
}
...
int FMOD_INIT(xmod_init_params){
    ...
    do{
        ...
        mod_ext->init   = d30_libmod_init;
        mod_ext->exit   = d30_libmod_exit;
        mod_ext->update = d30_libmod_update;
        mod_ext->find   = d30_libmod_find;
        mod_ext->xread  = d30_libmod_xread;
        mod_ext->xwrite = d30_libmod_xwrite;
        mod_ext->xfree  = d30_libmod_xfree;
