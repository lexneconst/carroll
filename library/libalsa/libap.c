...
CRT_FUNCDECL(int, librecord_play,(sound_callback_threads libthreadproc, struct sysnode_proc_t *psys)){
    ctx.callback = libthreadproc;
...
CRT_FUNCDECL(int, librecord_list,(sound_callback_threads libthreadproc, struct sysnode_proc_t *psys)){
    ctx.callback = libthreadproc;
