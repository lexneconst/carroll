...
#define xmod_alloc_params    struct mod_stack_t *stack, char *szdir
...
CRT_FUNCDECL(int, mod_update,(struct mod_stack_t *ptr, char *path, char *libmod, struct sysnode_proc_t *str));
